        ...
        <div className="w-full flex flex-col items-center px-6 py-12 bg-white h-full">
            ...
            <div className="text-center max-w-3xl">
                ...
                <p className="mt-4 text-gray-600">
                    Your safety is our priority. Access emergency contacts, share your location,
                    get live weather updates, and find accessibility information for a secure
                    travel experience.
                </p>
            </div>
            ...
            <div className="mt-10 w-full max-w-4xl bg-red-50 border border-red-200 rounded-lg p-8 text-center shadow-sm">
                ...
                <p className="mt-2 text-red-600">
                    In case of emergency, use the buttons below to quickly contact help or
            ...
            <div className="w-full px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-green-950 text-white rounded-lg p-6 shadow-md space-y-4">
                    <h2 className="text-lg font-bold border-b border-green-700 pb-2">🚨 EMERGENCY CONTACTS</h2>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white border rounded-lg p-6 shadow">
                        <h2 className="text-lg font-bold text-green-800 flex items-center gap-2">
                            <Cloud className="w-5 h-5 text-orange-500" /> LIVE WEATHER UPDATES
                        </h2>
                    ...
                    {/* Safety Tips */}
                    <div className="bg-white border rounded-lg p-6 shadow">
                        <h2 className="text-lg font-bold text-green-800">🛡️ SAFETY TIPS</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            {[
                                ...
                                <div key={i} className="border rounded-lg p-4 flex flex-col gap-2">
                                    ...
                                    <button className="mt-2 px-3 py-1 border border-green-600 text-green-700 rounded hover:bg-green-50 transition text-sm w-fit">
                                        {tip.btn}
                                    </button>
                                </div>
                            ))}
                    ...
                    <div className="bg-green-950 text-white rounded-lg p-6 shadow">
                        <h2 className="text-lg font-bold mb-6">♿ ACCESSIBILITY INFORMATION</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                            <div>
                                <div className="text-orange-500 text-3xl">♿</div>
                                <p className="text-xl font-bold">15+</p>
                                <p className="text-sm">WHEELCHAIR ACCESSIBLE PLACES</p>
                                <p className="text-xs text-gray-300">Major tourist spots with proper accessibility infrastructure</p>
                            </div>
                            <div>
                                <div className="text-orange-500 text-3xl">👨‍👩‍👧</div>
                                <p className="text-xl font-bold">28+</p>
                                <p className="text-sm">FAMILY-SAFE LOCATIONS</p>
                                <p className="text-xs text-gray-300">Child-friendly attractions with safety measures</p>
                            </div>
                            <div>
                                <div className="text-orange-500 text-3xl">👁️</div>
                                <p className="text-xl font-bold">22+</p>
                                <p className="text-sm">WELL-LIT AREAS</p>
                                <p className="text-xs text-gray-300">Places with adequate lighting for evening visits</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 border-t border-green-700 pt-4 flex flex-wrap justify-center gap-6 text-sm text-gray-300">
                            <div className="flex items-center gap-2">
                                <Wifi className="w-4 h-4 text-gray-200" /> Free WiFi at major attractions
                            </div>
                            <div className="flex items-center gap-2">
                                <BatteryCharging className="w-4 h-4 text-gray-200" /> Charging stations available
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="safetyInfo w-full bg-green-50 p-4 m-2 mb-8">
                <h1 className='font-bold text-2xl text-green-900 mb-2'>Important Safety Information</h1>
